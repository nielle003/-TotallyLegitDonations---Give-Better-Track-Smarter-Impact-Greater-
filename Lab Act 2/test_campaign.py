...
class TestCampaign(unittest.TestCase):
    ...
    def test_view_my_campaigns_with_data(self):
        """Test viewing user's campaigns when data exists"""
        print("\n🧪 TEST: View My Campaigns - With Data")
        
        # Mock data for user campaigns
        mock_campaigns = [
            ("Campaign 1", "Description 1", 1000, 200, "2023-12-31"),
            ("Campaign 2", "Description 2", 2000, 500, "2023-12-31")
        ]
        ...
        # Execute the method and capture output
        output, _ = self.capture_output(campaign.view_my_campaigns, user_id)
    ...
    def test_view_my_campaigns_no_data(self):
        """Test viewing user's campaigns when no data exists"""
        print("\n🧪 TEST: View My Campaigns - No Data")
        ...
        # Expected output
        expected_output = "You have not created any campaigns."
    ...
    def test_view_my_campaign_donations_with_data(self):
        """Test viewing user's campaign donations when data exists"""
        print("\n🧪 TEST: View My Campaign Donations - With Data")
        
        # Mock data for campaign donations
        mock_donations = [
            (1, "Campaign 1", 200.00, "2023-10-15"),
            (2, "Campaign 2", 500.50, "2023-10-20")
        ]
        
        # Set up mock database with test data
        mock_db = MockDatabase(mock_donations)
        campaign = Campaign(mock_db)
        ...
        expected_output_parts = [
            ...
            "Campaign ID: 2",
            "Title: Campaign 2",
            "Total Donations: $500.50"
        ]
        
        # Execute the method and capture output
        output, _ = self.capture_output(campaign.view_my_campaign_donations, user_id)
    ...
    def test_view_my_campaign_donations_no_data(self):
        """Test viewing user's campaign donations when no data exists"""
        print("\n🧪 TEST: View My Campaign Donations - No Data")
        ...
        # Expected output
        expected_output = "No donations found for your campaigns."
